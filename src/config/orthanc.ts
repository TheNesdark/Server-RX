...
const ORTHANC_URL_ENV = import.meta.env.ORTHANC_URL;
const ORTHANC_USERNAME_ENV = import.meta.env.ORTHANC_USERNAME;
const ORTHANC_PASSWORD_ENV = import.meta.env.ORTHANC_PASSWORD;
const ADMIN_USERNAME_ENV = import.meta.env.ADMIN_USERNAME;
const ADMIN_PASSWORD_ENV = import.meta.env.ADMIN_PASSWORD;

if (!ORTHANC_URL_ENV) {
  throw new Error('ORTHANC_URL no está definida en las variables de entorno');
}
...
if (!ADMIN_USERNAME_ENV) {
  throw new Error('ADMIN_USERNAME no está definida en las variables de entorno');
}
...
export const ADMIN_USERNAME = ADMIN_USERNAME_ENV;
export const ADMIN_PASSWORD = ADMIN_PASSWORD_ENV
